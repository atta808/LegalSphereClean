...
`;
    ...
    if (__DEV__) console.log("❌ analyzeDocument error:", error?.message || error);
...
`;
    ...
    if (__DEV__) console.log("❌ analyzeCase error:", error?.message || error);
...
`;
    ...
    if (__DEV__) console.log("❌ analyzeDashboard error:", error?.message || error);
...
const generalAssistant = async ({ question }) => {
  try {
    ...
    if (__DEV__) console.log("❌ generalAssistant error:", error?.message || error);
